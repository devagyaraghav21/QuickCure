...
const getAppointments = async () => {
    try {
        ...
        const {data} = await axios.get(backendUrl + '/api/doctors/appointments',{headers:{ dtoken: dToken }})
...
//api for cancel and complete appointments in doctor panel COMNNECTING BACKEND AND ADMIN
