...
const Login = () => {
  ...
  return (
    ...
    <div className='flex flex-col items-start p-8 min-w-[340px] gap-3 m-auto sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
      <p className='text-sxl font-semibold'>{state === 'Sign Up' ? "Create Account" : "Login"}</p>
